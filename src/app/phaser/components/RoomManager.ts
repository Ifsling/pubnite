...
export default class RoomManager {
  ...
  private static readonly P_GUN = 0.015
  private static readonly P_AMMO = 0.02
  private static readonly P_MISC = 0.004
  ...
  private static readonly ROOM_GUN_MIN_DIST_FROM_SPAWN = 64
  private static readonly ROOM_ITEM_SCALE = 0.3

  // NOTE: removed prevWorldBounds — we no longer change world bounds
  ...
  enterRoom(roomKey: string, entryPointOutside: Phaser.Math.Vector2) {
    ...
    // 8) camera (NO world bounds changes!)
  ...
  exitRoom(exitPointOutside: Phaser.Math.Vector2) {
    ...
    // physics + camera cleanup (NO world bounds restoration needed anymore)
